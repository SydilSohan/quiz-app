...
export type JoinedReviewRoute = Partial<Tables<'reviews'>> & {
  routes: Partial<Tables<'routes'>>;
};
...
export function ReviewCard({
  ...
  return (
    <Card className="rounded-2xl shadow-md my-2 break-inside-avoid-column">
      ...
      <CardContent>
        <figure className="">
          <blockquote>
            <p className="text-gray-700 text-sm sm:text-sm font-normal ">
              {review.message}
            </p>
            {review.rating && (
        ...
        {route_name && (
          <span className=" mt-2 text-xs text-gray-600">
            Review on route - {route_name}
          </span>
        )}
      </CardContent>

      <CardFooter className="flex  gap-3 items-center justify-start">
